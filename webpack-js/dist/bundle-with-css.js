...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../_css-loader@0.28.9@css-loader/index.js!./layout.css", function() {
			var newContent = require("!!../../../_css-loader@0.28.9@css-loader/index.js!./layout.css");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../_css-loader@0.28.9@css-loader/index.js!./skin-gray.css", function() {
			var newContent = require("!!../../../_css-loader@0.28.9@css-loader/index.js!./skin-gray.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
